...
# Assess data quality
quality <- pep_quality(pep_alpine, phase_id = 65)
summary(quality)
...
sync <- pheno_synchrony(pep_alpine, phase_id = 65)
summary(sync)
```
-->
