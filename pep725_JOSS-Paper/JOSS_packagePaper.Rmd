...
By implementing the methods described in @templetal2026a as reproducible R workflows with explicit quality diagnostics, **pep725** lowers the barrier to conducting such analyses on large phenological observation networks. Four vignettes and a synthetic dataset generator support both research applications and teaching in phenology and environmental data analysis.
