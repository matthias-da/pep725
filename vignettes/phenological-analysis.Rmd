...
For large datasets or repeated analyses, it is often inefficient to recompute phenological normals each time. Instead, normals can be calculated once for a chosen reference period and then reused for multiple years or subsets of the data:
