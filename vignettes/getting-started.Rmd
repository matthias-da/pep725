...
# Always verify the subset contains data
if (nrow(vine_flowering) > 0) {
  ...
  if (nrow(vine_annual) > 1) {
    plot(vine_annual$year, vine_annual$mean_doy,
         type = "b",
         xlab = "Year",
         ylab = "Mean Day of Year",
         main = "Grapevine Flowering Date Over Time",
         pch = 19,
         col = "purple")

    if (nrow(vine_annual) >= 3) {
  ...
  cat("No grapevine flowering data available in this subset.\n")
}
```
